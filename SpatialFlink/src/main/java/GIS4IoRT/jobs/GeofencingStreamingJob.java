...
public class GeofencingStreamingJob implements Serializable {
    private static final Logger LOG = LoggerFactory.getLogger(GeofencingStreamingJob.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Control Stream: Start from earliest to restore Zone/Assignment state
        ...
        // Robot Stream: Real-time GPS data
        ...
        // Session Manager: Blocks unknown robots & Assigns zones to allowed ones
        ...
        DataStream<String> throttledAlerts = alerts
                ...
                (r1, r2) -> r2,new ProcessWindowFunction<AssignedPoint, String, String, TimeWindow>() {
                    ...
                    public void process(String robotID, Context context, Iterable<AssignedPoint> elements, Collector<String> out) {
                        ...
                        String msgContent = "Outside of the zone";

                        String jsonMessage = String.format(
                                "{\"window_start\": \"%d\", \"window_end\": \"%d\", \"object_id\": \"%s\", \"message\": \"%s\"}",
                                start, end, robotID, msgContent
                        );
...
//                            "{\"id\": \"%s\", \"ts\": %d, \"lat\": %.6f, \"lon\": %.6f, \"msg\": \"OUTSIDE\", \"zones\": \"%s\"}",
//                            ap.objID,
